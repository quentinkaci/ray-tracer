...
{
public:
    Plane(const TextureMaterial &texture_material, const primitives::Point3 &pos, const primitives::Vector3 &normal);
    ...
    primitives::Point3 get_planar_projection(const primitives::Point3 &A) const override;
